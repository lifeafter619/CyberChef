    ...
    toHtml() {
        ...
        switch (this.type) {
            ...
            case "binaryShortString":
                ...
                break;
            case "toggleString":
                html += `<div class="form-group input-group ing-wide" data-help-title="多类型配料" data-help="从下拉菜单中选择数据类型将改变操作对配料的解析方式。">
            ...
            case "populateMultiOption":
                html += `<div class="form-group ing-medium" data-help-title="预设下拉框" data-help="从此下拉框选择值会用预设值填充该操作的部分其他配料。">
                    <label for="${this.id}"
                        ${this.hint ? `data-toggle="tooltip" title="${this.hint}"` : ""}
                        class="bmd-label-floating">${this.name}</label>
                    <select
            ...
            case "text":
                ...
                break;
            case "argSelector":
                html += `<div class="form-group inline ing-medium" data-help-title="配料选择器" data-help="在此下拉框中选择选项会配置哪些操作配料可见。">
                    <label for="${this.id}"
                        ${this.hint ? `data-toggle="tooltip" title="${this.hint}"` : ""}
                        class="bmd-label-floating inline">${this.name}</label>
                    <select
