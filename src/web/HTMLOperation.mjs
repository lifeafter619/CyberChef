...
class HTMLOperation {
    ...
    toFullHtml() {
        ...
        <div class="recip-icons">
            <i class="material-icons breakpoint" title="设置断点" break="false" data-help-title="设置断点" data-help="在操作上设置断点会使配方执行在到达该操作时暂停。">pause</i>
            <i class="material-icons disable-icon" title="禁用操作" disabled="false" data-help-title="禁用操作" data-help="禁用操作会阻止其在配方烘焙时被执行。执行会跳过禁用操作并继续后续操作。">not_interested</i>
            <i class="material-icons hide-args-icon" title="隐藏操作参数" hide-args="false" data-help-title="隐藏操作参数" data-help="隐藏操作参数可节省配方窗口空间。执行仍会按照所选参数选项进行。">keyboard_arrow_up</i>
        </div>
...
function titleFromWikiLink(urlStr) {
    ...
    return `<a href='${urlObj.href}' target='_blank'>${pageTitle}<i class='material-icons inline-icon'>open_in_new</i></a>（${wikiName}）`;
}
